...
--
-- Nota:
-- - Varias tablas todavía no tienen endpoints/uso, pero se van a usar después.
-- - Si quieres un esquema mínimo (MVP), usa: database/init.core.sql
-- ===============================
...
-- (aunque el tracking no esté activo hoy, se conservará para uso futuro)
-- ===============================

...
--
-- WHY:
-- - El proyecto evolucionó y varias tablas eran “proyección” (roles, catálogo musical, narrativa, etc.).
-- - Hoy el código (APIs PHP + front) solo usa un subconjunto.
-- - Para evitar confusión, este init.sql crea únicamente lo necesario.
--
-- Si necesitas la versión completa anterior, está en: database/init.full.sql
-- ===============================
